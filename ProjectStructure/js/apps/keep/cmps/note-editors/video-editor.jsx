        ...
        return (
            <div className="card-video">
                <form className="video-modal" onSubmit={this.handleSubmit}>
                    ...
                    <input className="note-url-input" type="text" id="video-input" name="url" value={`https://www.youtube.com/watch?v=${url}` || ''} placeholder="Enter video url" onChange={this.handleChange} />
