...
function query(filterBy = null) {
  ...
  console.log('before promise', filteredBooks)
...
// && car.speed >= minSpeed && car.speed <= maxSpeed
function saveBook(bookToSave) {
  _addBook(bookToSave)
  return Promise.resolve(bookToSave)
}
// function saveBook(bookToSave) {
//   return bookToSave.id ? _updateBook(bookToSave) : _addBook(bookToSave)
// }



function _addBook(bookToSave) {
...
// function _updateBook(bookToSave) {
//   const books = _loadBooksFromStorage();
//   var bookIdx = books.findIndex(function (book) {
//       return book.id === bookToSave.id;
//   })
//   books[bookIdx] = bookToSave
//   _saveBooksToStorage(books);
//   return Promise.resolve()
// }
